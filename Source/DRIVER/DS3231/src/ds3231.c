...
{
    I2CRead(DS3231_ADDR, Addr, buf, size);
}
void DS3231_WriteReg(uint8_t Addr,uint8_t *buf, uint8_t size)
{
    I2CWrite(DS3231_ADDR, Addr, buf, size);
}
...
{
    I2CRead(DS3231_ADDR, DS3231_A1_SECONDS, buf, size);
}

void DS3231_SetAlarm1(uint8_t *buf, uint8_t size)
{
    I2CWrite(DS3231_ADDR, DS3231_A1_SECONDS, buf, size);
}
